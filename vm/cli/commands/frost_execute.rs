...
/// Executes a Frost Intent
#[derive(Debug, Parser)]
pub struct FrostExecute {
    ...
    offline: bool,
    // todo: Add message
    // message: Vec<Field<CurrentNetwork>>,
}
...
impl FrostExecute {
    ...
    pub fn parse(self) -> Result<String> {
        ...
        let (response, execution, metrics) =
            package.frost_execute::<Aleo, _>(self.endpoint, &private_key, self.function, &self.inputs, rng)?;
